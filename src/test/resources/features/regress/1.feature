...
Feature: Add new beneficiary
  ...
  Scenario Outline: Add new beneficiary. Without optional. [To myself]
    ...
    * user (checking that new beneficiary appear in list of beneficiaries)
    ...
    Examples:
      | Country | Currency        | Name      | Last Name      | IBAN                     | BIC         |
      | Austria | Euro            | Test Name | Test last Name | AT61 1904 3002 3457 3201 | RLBBAT2E028 |
      | Norway  | Norwegian Krona | Artem     | Sokovets       | NO93 8601 1117 947       | LABANOKK    |